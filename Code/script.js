$(document).ready(function () {
    ...
    function switchScreen(from, to) {
        $(`#${from}`).fadeOut(400, function () {
            $(`#${from}`).addClass('d-none');
            $(`#${to}`).removeClass('d-none').hide().fadeIn(400);
    ...
    function calculateAndShowResults() {
        ...
        if (percent >= 80) {
            $('#result-title').text('TIMELINE STABILIZED');
            ...
            $('#result-title').text('PARTIAL SYNC');
